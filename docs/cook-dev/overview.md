...
모든 정보가 통합 어드민툴을 통해 집약이 되고, 모든 프로젝트를 어드민툴에서 기획자가 직접 개발을 드리븐 할 수 있게 지원하는 것을 목표로 하고 있으며. 빠른 웹툴 개발을 위해 Vue 기반의 Quasar Framwork를 활용하고 있습니다. 굳이 뻔한 내용을 언급한 이유는, 어드민툴을 차후에 붙여가면서 작업을 하느냐 어드민툴을 통해서 드리븐을 하느냐에서 생산성의 차이가 올수 있다는점 입니다

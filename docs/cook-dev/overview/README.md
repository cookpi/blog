...
서버가 코어 로직에만 집중하고 CRUD 를 클라이언트에게 넘겨주는 순간 프로젝트 생산성이 엄청나게 올라갑니다. 안 써본 사람은 있어도 한번만 써본 사람은 없다는게 GraphQL 인데, GraphQL 설명은 내용이 많아 여기 설명을 못하고 별도 연재하겠습니다. (남자한테 참 좋은데, 이거 뭐라 설명할 수도 없고... <span class="small">- 광고 패러디 입니다. 특정 성을 옹호나는 것이 아닙니다 ㅠㅠ</span>)
